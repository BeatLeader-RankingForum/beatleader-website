...
export const BL_API_URL = (() => {
	if (location.host.includes('localhost') || location.host.includes('beatleader.xyz') || location.host.includes('lightai.dev')) {
...
export const RF_GATEWAY_API_URL = 'https://rfapi.lightai.dev/';
