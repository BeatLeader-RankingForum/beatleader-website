...
if (window.location.host.includes('netlify.app') || window.location.host.includes('stage') || window.location.host.includes('test') || window.location.host.includes('rankingforum')) {
	lcount = 3;
}
